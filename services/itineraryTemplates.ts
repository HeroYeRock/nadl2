...
const TEMPLATES: Record<string, DayArea[]> = {
  ...
  "가오슝": [
    ...
    { query: "가오슝 불광산 포광산 대불", label: "불광산 (근교)" },
  ],
  "타이중": [
    { query: "타이중 궁원안과 타이중역 제2시장", label: "타이중역 / 궁원안과" },
    { query: "타이중 심계신촌 국립대만미술관 근대미술관", label: "심계신촌 / 미술관" },
    { query: "타이중 무지개마을 고미습지", label: "무지개마을 / 고미습지" },
    { query: "타이중 펑지아 야시장 국가가극원 치차이호", label: "펑지아 / 국가가극원" },
  ],
  ...
  "상하이": [
    ...
    { query: "상하이 징안사 난징시루", label: "징안사 / 난징시루" },
  ...
  "베이징": [
    ...
    { query: "베이징 이화원 여름궁전", label: "이화원" },
    { query: "베이징 798 예술구 산리툰", label: "798 예술구 / 산리툰" },
  ],
  "청두": [
    { query: "청두 춘시루 타이구리 IFS", label: "춘시루 / 타이구리" },
    { query: "청두 자이언트 판다 번식연구기지", label: "판다 기지" },
    { query: "청두 콴자이샹즈 인민공원 학자찻집", label: "콴자이샹즈 / 인민공원" },
    { query: "청두 진리 우허우츠 금리거리", label: "진리 / 우허우츠" },
    { query: "두장옌 칭청산 청두 근교", label: "두장옌 (근교)" },
  ],
};
